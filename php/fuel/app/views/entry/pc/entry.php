      ...
      <div class="l-contents">
        <div class="form">
          ...
          <div class="l-block">
            <div class="step">
              <ul class="step-list">
                <li class="current step-item">エントリー入力</li>
          ...
          <div class="l-block form-cont">
            <div class="l-inner">
              ...
              ?>
                ...
                <div class="form-head">
                  <p></p>以下のエントリー情報を入力し【内容確認へ】ボタンを押してください。<br>エントリー頂いた後抽選を行い、結果をメールにてお送りします。
                ...
                <div class="box">
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      ...
                      <div class="box-table__cont"><?php echo $shop['shop_name'];?></div>
                    </div>
                  </div>
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">コース<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                        <p class="box-block"><?php echo $dis_course_type;?>コース</p>
                        <ul class="box-list">
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      ...
                      <div class="box-table__cont"><?php echo $dis_visit_date;?></div>
                    </div>
                  </div>
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">来店時間<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">来店人数<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                        <ul class="box-list">
                          <?php
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      ...
                      <div class="box-table__cont">
                        <p class="box-block">食べ物アレルギーの情報など、お店にお伝えしたいことがあればご記入ください。</p>
                ...
                <div class="box">
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">お名前<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                        <?php echo Form::input('user_name', Input::post('user_name', ''),
                        		array('placeholder'=>'入力例：東京　花子', 'class'=>'text-m '.(isset($errors['user_name'])?'error':'')));?>
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">お名前（カナ）<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                        <?php echo Form::input('user_name_kana', Input::post('user_name_kana', ''),
                        		array('placeholder'=>'入力例：トウキョウ　ハナコ', 'class'=>'text-m '.(isset($errors['user_name_kana'])?'error':'')));?>
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">メールアドレス<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                        <?php echo Form::input('user_mail_address', Input::post('user_mail_address', ''),
                        		array('placeholder'=>'入力例：ex@example.com',
                        			  'class'=>'text-l '.(isset($errors['user_mail_address'])?'error':'')));?>
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">メールアドレスの確認<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">電話番号<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">性別<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                        <ul class="box-list">
                            <?php
                  ...
                  <div class="box-inner">
                    <div class="box-table">
                      <div class="box-table__head">年齢<span class="tag tag-necessary">必須</span></div>
                      <div class="box-table__cont">
                        <label class="select-wrap" for="user_age">
                        <?php $age_value = array(
                        		''=>'選択してください',
                        		'20歳～24歳'=>'20歳～24歳',
                        		'25歳～29歳'=>'25歳～29歳',
